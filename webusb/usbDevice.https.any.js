...
usb_test(async() => {
  ...
  await device.selectConfiguration(1);
  assertDeviceInfoEquals(device.configuration,
      fakeDeviceInit.configurations[0]);
  await device.selectConfiguration(2);
  assertDeviceInfoEquals(device.configuration,
      fakeDeviceInit.configurations[1]);
  await device.close();
...
usb_test(async() => {
  ...
  usbRequestTypes.forEach(requestType => {
    usbRecipients.forEach(async(recipient) => {
